...
# to Untar
- tar -zvxf apache-tomcat-8.5.97.tar.gz
...
# to start the services 
 ...
 # go to 
- cd /home/ec2-user/apache-tomcat-8.5.97/bin/
- ./startup.sh
...
- /home/ec2-user/apache-tomcat-8.5.97/webapps/host-manager/META-INF/context.xml
- /home/ec2-user/apache-tomcat-8.5.97/webapps/manager/META-INF/context.xml
...
# /home/ec2-user/apache-tomcat-8.5.97/conf/tomcat-users.xml file
...
# Restart the server 
- /home/ec2-user/tomcat/apache-tomcat-8.5.97/bin/shutdown.sh
- /home/ec2-user/tomcat/apache-tomcat-8.5.97/bin/startup.sh
